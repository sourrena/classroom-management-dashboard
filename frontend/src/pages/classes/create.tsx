  ...
  return (
    <Create saveButtonProps={saveButtonProps}>
      ...
      >
        ...
        >
          <Input placeholder="Full-Stack Web Development" />
        </Form.Item>
        ...
        >
          <Select {...subjectSelectProps} placeholder="Select subject" />
        </Form.Item>
        ...
        >
          <Select {...teacherSelectProps} placeholder="Select teacher" />
        </Form.Item>
        ...
        <Form.Item label="Description" name="description">
          <Input.TextArea
            rows={4}
            placeholder="A practical class about frontend, backend, APIs, and databases."
          />
        </Form.Item>
